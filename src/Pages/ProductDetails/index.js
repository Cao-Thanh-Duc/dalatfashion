        ...
        <div className="row">
          ...
          <div className="col-md-7 pl-5 pr-5">
            ...
            <div className="d-flex info mb-3">
              <span className="oldPrice"> 499.000 VNĐ</span>
              <span className="newPrice text-danger ml-3"> 299.000 VNĐ</span>
            </div>
            ...
            <div className="ProductSize d-flex align-items-center">
              ...
              <ul className="list list-inline mb-0 pl-2">
                ...
                <li className="list-inline-item">
                  <a
                    className={`tag ${activeColor === 5 ? "active" : ""}`}
                    onClick={() => isActiveColor(5)}
                  >
                    Brown
                  </a>
                </li>
                <li className="list-inline-item">
                  <a
                    className={`tag ${activeColor === 6 ? "active" : ""}`}
                    onClick={() => isActiveColor(6)}
                  >
                    Red
                  </a>
                </li>
                <li className="list-inline-item">
                  <a
                    className={`tag ${activeColor === 7 ? "active" : ""}`}
                    onClick={() => isActiveColor(7)}
                  >
                    Pink
                  </a>
                </li>
